...
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || "Pirate's Treasure";
const GAME_TAGLINE = import.meta.env.VITE_GAME_TAGLINE || 'A 2-player treasure-hunt on Stellar';
